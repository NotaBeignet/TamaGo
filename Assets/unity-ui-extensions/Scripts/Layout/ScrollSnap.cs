...
namespace UnityEngine.UI.Extensions
{
    ...
    public class ScrollSnap : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollSnap
    {
        ...
        public void NextScreen()
        {
            ...
            if (VisiblePage() < _pages - 1)
            {
                _lerp = true;
                _lerpTarget = _pageAnchorPositions[VisiblePage() + 1];

                PageChanged(VisiblePage() + 1);
            }
        }
        ...
        public void OnEndDrag(PointerEventData eventData)
        {
            ...
            if (UseFastSwipe)
            {
                ...
                {
                    _lerp = true;
                    _lerpTarget = _pageAnchorPositions[VisiblePage()];
                }
            }
            else
            {
